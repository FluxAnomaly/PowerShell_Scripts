...
$work_dir = 'C:\PROJECTS\AV ENC checks\01-28-21\'
...
$docheader = "<list id='1'>
  <query id='2'>
    ...
    <table-uri>query:table?orion.table.order=asc&amp;orion.table.columns=EPOLeafNode.NodeName%3AEPOLeafNode.LastUpdate%3AEPOProdPropsView_MVISIONENDPOINT.productversion%3AMVIS_EP_CustomProps.DefenderAntivirusSigLastUpdated%3AEPOProdPropsView_TIECLIENTMETA.productversion%3AEPOProdPropsView_THREATPREVENTION.productversion%3AEPOProdPropsView_MCAFEE_MNE.productversion%3AMneFVProperties.MachineEncryptionStatus%3AEPOProdPropsView_MCAFEE_EED.productversion%3AEPOProdPropsView_MCAFEE_EEPC.productversion%3AEPESystems.State%3AEPESystems.EncryptionProvider&amp;orion.table.order.by=EPOLeafNode.NodeName</table-uri>
