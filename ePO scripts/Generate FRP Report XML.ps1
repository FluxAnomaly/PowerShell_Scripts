...
$QueryName = "FRP_Report-$time"
$inputfile = "C:\Projects\Audit\FRP\hostlist.txt"
$outputfile = "C:\Projects\Audit\FRP\$QueryName.xml"
...
$docheader = "<list id='1'>
  <query id='2'>
    ...
    <table-uri>query:table?orion.table.order=asc&amp;orion.table.columns=EPOLeafNode.NodeName%3AEPOProdPropsView_EEFF.productversion%3AEPOComputerProperties.UserName%3AEPOComputerProperties.DomainName%3AEPOLeafNode.LastUpdate&amp;orion.table.order.by=EPOLeafNode.NodeName</table-uri>
