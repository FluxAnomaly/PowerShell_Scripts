...
$QueryName = "ePO-Tanium-$time"
$WorkingDir = "C:\Projects\Agent issues\10-19-20 Tanium\"

$inputfile = "hostlist.txt"
$outputfile = "$WorkingDir"+"$QueryName.xml"
$inputSource = "$WorkingDir"+"$inputfile"

# DO NOT EDIT BELOW HERE:  -----------------------------------------------------------------------------------------

# XML chunks. 
# Doc header <table-uri> determines which columns are in output. Ex:  table.columns=EPOLeafNode.NodeName , ComputerProperties.IPV6 , ComputerProperties.UserName
$docheader = "<list id='1'>
  <query id='2'>
    <dictionary id='3'/>
    <name>$QueryName</name>
    ...
    <table-uri>query:table?orion.table.order=asc&amp;orion.table.columns=EPOLeafNode.NodeName%3AEPOComputerProperties.IPV6%3AEPOComputerProperties.UserName%3AEPOLeafNode.LastUpdate%3AEPOProdPropsView_EPOAGENT.productversion%3AEPOComputerProperties.OSType&amp;orion.table.order.by=EPOLeafNode.NodeName</table-uri>
